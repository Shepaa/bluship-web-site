...
export const HeroSection = ({ isOpen }) => {
  return (
      <div className={style.wrapper}>
        ...
        <div className={`${style.rocketImgContainer} ${isOpen ? style.menuOpen : ''}`}>
          <img src={rocketImg} className={style.desktopImg} alt="Rocket for PC"/>
          <img src={rocketImgTablet} className={style.rocketImgTablet} alt="Rocket for Tablet"/>
          <img src={rocketImgMobile} className={style.rocketImgMobile} alt="Rocket for Mobile"/>
        </div>
      </div>
  );
};